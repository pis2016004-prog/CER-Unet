...
from icenet.network_architecture.tumor.unetr_pp_tumor import UNETR_PP
...
from icenet.training.network_training.Trainer_tumor import Trainer_tumor
...
class icenet_trainer_tumor(Trainer_tumor):
    """
