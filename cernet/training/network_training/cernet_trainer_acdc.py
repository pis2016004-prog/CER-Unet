...
import numpy as np
import torch
from cernet.training.data_augmentation.data_augmentation_moreDA import get_moreDA_augmentation
from cernet.training.loss_functions.deep_supervision import MultipleOutputLoss2
from cernet.utilities.to_torch import maybe_to_torch, to_cuda
from cernet.network_architecture.initialization import InitWeights_He
from cernet.network_architecture.neural_network import SegmentationNetwork
from cernet.training.data_augmentation.default_data_augmentation import default_2D_augmentation_params, \
    get_patch_size, default_3D_augmentation_params
from cernet.training.dataloading.dataset_loading import unpack_dataset
from cernet.training.network_training.Trainer_acdc import Trainer_acdc
from cernet.utilities.nd_softmax import softmax_helper
from sklearn.model_selection import KFold
from torch import nn
from torch.cuda.amp import autocast
from cernet.training.learning_rate.poly_lr import poly_lr
from batchgenerators.utilities.file_and_folder_operations import *
from cernet.network_architecture.acdc.cernet_acdc import UNETR_PP
from fvcore.nn import FlopCountAnalysis


class cernet_trainer_acdc(Trainer_acdc):
    """
