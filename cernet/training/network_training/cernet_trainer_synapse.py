...
from cernet.network_architecture.synapse.cernet_synapse import UNETR_PP
...
from cernet.training.network_training.Trainer_synapse import Trainer_synapse
...
class cernet_trainer_synapse(Trainer_synapse):
    """
