...
from cernet.configuration import default_num_threads
from cernet.experiment_planning.DatasetAnalyzer import DatasetAnalyzer
from cernet.experiment_planning.common_utils import get_pool_and_conv_props_poolLateV2
from cernet.experiment_planning.utils import create_lists_from_splitted_dataset
from cernet.network_architecture.generic_UNet import Generic_UNet
from cernet.paths import *
from cernet.preprocessing.cropping import get_case_identifier_from_npz
...
class ExperimentPlanner(object):
    ...
    def run_preprocessing(self, num_threads):
        ...
        preprocessor_class = recursive_find_python_class([join(cernet.__path__[0], "preprocessing")],
                                                         self.preprocessor_name, current_module="cernet.preprocessing")
