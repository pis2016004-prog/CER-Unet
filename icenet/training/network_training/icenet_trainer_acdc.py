...
import numpy as np
import torch
from icenet.training.data_augmentation.data_augmentation_moreDA import get_moreDA_augmentation
from icenet.training.loss_functions.deep_supervision import MultipleOutputLoss2
from icenet.utilities.to_torch import maybe_to_torch, to_cuda
from icenet.network_architecture.initialization import InitWeights_He
from icenet.network_architecture.neural_network import SegmentationNetwork
from icenet.training.data_augmentation.default_data_augmentation import default_2D_augmentation_params, \
    get_patch_size, default_3D_augmentation_params
from icenet.training.dataloading.dataset_loading import unpack_dataset
from icenet.training.network_training.Trainer_acdc import Trainer_acdc
from icenet.utilities.nd_softmax import softmax_helper
from sklearn.model_selection import KFold
from torch import nn
from torch.cuda.amp import autocast
from icenet.training.learning_rate.poly_lr import poly_lr
from batchgenerators.utilities.file_and_folder_operations import *
from icenet.network_architecture.acdc.icenet_acdc import UNETR_PP
from fvcore.nn import FlopCountAnalysis


class icenet_trainer_acdc(Trainer_acdc):
    """
    ...
    def run_iteration(self, data_generator, do_backprop=True, run_online_evaluation=False):
        ...
        if self.fp16:
            ...
            del data
            l = self.loss(output, target)
            l= l + 0.1*kl_loss  # add KL loss if it is present
