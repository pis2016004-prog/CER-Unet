...
from icenet.network_architecture.synapse.icenet_synapse import UNETR_PP
...
from icenet.training.network_training.Trainer_synapse import Trainer_synapse
...
class icenet_trainer_synapse(Trainer_synapse):
    """
