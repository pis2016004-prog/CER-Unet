...
from icenet.training.network_training.Trainer_lung import Trainer_lung
...
from icenet.network_architecture.lung.icenet_lung import UNETR_PP
from fvcore.nn import FlopCountAnalysis


class icenet_trainer_lung(Trainer_lung):
    """
