...
import torch
from icenet.network_architecture.dynunet_block import UnetResBlock
import math
from functools import partial
import torch.nn.functional as F
import math

# ---- timm compatibility imports (works across old & new versions) ----
# trunc_normal_ / DropPath moved from timm.models.layers -> timm.layers
try:
    from timm.layers import trunc_normal_, DropPath
except ImportError:  # older timm
    from timm.models.layers import trunc_normal_, DropPath

# Some repos used trunc_normal_tf_; alias it to trunc_normal_
trunc_normal_tf_ = trunc_normal_

# named_apply moved around in timm:
# - newer: timm.models._manipulate.named_apply
# - older: timm.models.helpers.named_apply (or timm.models.layers.named_apply in very old)
try:
    ...
    try:
        ...
        from timm.models.layers import named_apply  # fallback for very old timm
# ----------------------------------------------------------------------
