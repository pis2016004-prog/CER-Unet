...
from icenet.network_architecture.acdc.model_components import UnetrPPEncoder, UnetrUpBlock
import os
import torch
...
class UNETR_PP(SegmentationNetwork):
    ...
    def forward(self, x_in):
        ...
        # t4_trans = enc4.permute(0, 2, 1)                  # [1, 256, 50]
        # t4_reduced = self.conv1d_t4(t4_trans)             # [1, 16, 50]
        # t4_flat = self.fc_t4(t4_reduced)  
        # [1, 16, 25600]
        # enc4: [B, 50, 256] → transformer output tokens
        ...
        # print("t4",t4_reshaped.shape)  # [1, 16, 16, 40, 40]
        # print("t3",t3_up.shape)  # [1, 16, 16, 40, 40]
        # print("t2",t2_up.shape)  # [1, 64, 16, 40, 40]
        # print("t1",t1.shape)  # [1, 16, 16, 40, 40]
        # B, C, F1 = t4_flat.shape  # (1, 16, 3276800 // 16)
        # T = 32
        # HW = F1 // T
        # H = int(HW**0.5)
        # W = HW // H

        # t4_reshaped = t4_flat.view(B, C, T, H, W)
        ...
        # print("o1", o1.shape)  # (16, 64, 40, 40)
        # print("o2", o2.shape)  # (16, 64, 40, 40)
        # print("o3", o3.shape)  # (16, 64, 40, 40)
        # print("o4", o4.shape)  # (16, 64, 40, 40)
...
#         else:
#             logits = self.out1(out)
#         dummy_loss = torch.tensor(0.0, requires_grad=True).to(x_in.device)
